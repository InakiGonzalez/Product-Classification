...
from tensorflow.keras.applications import (
    ResNet50, ResNet101, DenseNet121, DenseNet169, InceptionV3, EfficientNetV2S
)
...
class FoundationalCVModel:
    ...
    def __init__(self, backbone, mode='eval', input_shape=(224, 224, 3)):
        ...
        elif backbone == 'efficientnet_v2s':
            self.base_model = EfficientNetV2S(include_top=False, weights='imagenet', input_shape=input_shape)
        ...
        # If is a model from keras.applications:
            ...
            # In this case the pooling layer is not included in the model, we use GlobalAveragePooling2D
